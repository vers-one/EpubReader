namespace VersOne.Epub.Test.Unit.TestData
{
    internal static class TestEpubData
    {
        ...
        public const EpubContentType AUDIO_CONTENT_TYPE = EpubContentType.AUDIO_MP3;
        public const string AUDIO_MPEG_CONTENT_MIME_TYPE = "audio/mpeg";
        public const string AUDIO1_FILE_NAME = "audio1.mp3";
        public const string AUDIO1_FILE_PATH = $"{CONTENT_DIRECTORY_PATH}/{AUDIO1_FILE_NAME}";
        public const string AUDIO2_FILE_NAME = "audio2.mp3";
        public const string AUDIO2_FILE_PATH = $"{CONTENT_DIRECTORY_PATH}/{AUDIO2_FILE_NAME}";
        public const EpubContentType OTHER_CONTENT_TYPE = EpubContentType.OTHER;
        public const string VIDEO_MP4_CONTENT_MIME_TYPE = "video/mp4";
        public const string VIDEO_FILE_NAME = "video.mp4";
        public const string VIDEO_FILE_PATH = $"{CONTENT_DIRECTORY_PATH}/{VIDEO_FILE_NAME}";
        ...
        public const string REMOTE_VIDEO_CONTENT_FILE_HREF = "https://example.com/books/123/video.mp4";
