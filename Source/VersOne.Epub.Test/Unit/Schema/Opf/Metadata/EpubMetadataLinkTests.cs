...
namespace VersOne.Epub.Test.Unit.Schema.Opf.Metadata
{
    public class EpubMetadataLinkTests
    {
        ...
        {
            EpubMetadataLink epubMetadataLink = new(HREF, ID, MEDIA_TYPE, Properties, REFINES, Relationships);
        ...
        {
            Assert.Throws<ArgumentNullException>(() => new EpubMetadataLink(null!, ID, MEDIA_TYPE, Properties, REFINES, Relationships));
        }
        ...
        {
            EpubMetadataLink epubMetadataLink = new(HREF, null, MEDIA_TYPE, Properties, REFINES, Relationships);
            Assert.Equal(HREF, epubMetadataLink.Href);
        ...
        {
            EpubMetadataLink epubMetadataLink = new(HREF, ID, null, Properties, REFINES, Relationships);
            Assert.Equal(HREF, epubMetadataLink.Href);
            Assert.Equal(ID, epubMetadataLink.Id);
        ...
        {
            EpubMetadataLink epubMetadataLink = new(HREF, ID, MEDIA_TYPE, null, REFINES, Relationships);
            Assert.Equal(HREF, epubMetadataLink.Href);                    
            Assert.Equal(ID, epubMetadataLink.Id);
            Assert.Equal(MEDIA_TYPE, epubMetadataLink.MediaType);
        ...
        {
            EpubMetadataLink epubMetadataLink = new(HREF, ID, MEDIA_TYPE, Properties, null, Relationships);
            Assert.Equal(HREF, epubMetadataLink.Href);     
            Assert.Equal(ID, epubMetadataLink.Id);
            Assert.Equal(MEDIA_TYPE, epubMetadataLink.MediaType);
            Assert.Equal(Properties, epubMetadataLink.Properties);
        ...
        {
            EpubMetadataLink epubMetadataLink = new(HREF, ID, MEDIA_TYPE, Properties, REFINES, null);
            Assert.Equal(HREF, epubMetadataLink.Href);
            Assert.Equal(ID, epubMetadataLink.Id);
            Assert.Equal(MEDIA_TYPE, epubMetadataLink.MediaType);
            Assert.Equal(Properties, epubMetadataLink.Properties);
