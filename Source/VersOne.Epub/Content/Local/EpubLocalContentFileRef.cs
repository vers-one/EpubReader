...
namespace VersOne.Epub
{
    ...
    public abstract class EpubLocalContentFileRef : EpubContentFileRef
    {
        ...
        /// <param name="contentFileEntry">The reference to the underlying local content file in the EPUB archive.</param>
        ...
        protected EpubLocalContentFileRef(EpubContentFileRefMetadata metadata, string filePath, IZipFileEntry? contentFileEntry,
        ...
        /// <summary>
        /// Gets the reference to the underlying local content file in the EPUB archive or <c>null</c> if the file is not present in the EPUB archive.
        /// </summary>
