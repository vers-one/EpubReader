...
namespace VersOne.Epub
{
    ...
    public class EpubLocalTextContentFileRef : EpubLocalContentFileRef
    {
        ...
        public EpubLocalTextContentFileRef(EpubContentFileRefMetadata metadata, string filePath, IZipFileEntry? contentFileEntry,
            IEpubContentLoader epubContentLoader)
            : base(metadata, filePath, contentFileEntry, epubContentLoader)
        {
        }
