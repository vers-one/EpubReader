...
namespace VersOne.Epub.Schema
{
    ...
    /// <para>See <see href="https://www.w3.org/TR/epub/#sec-link-properties" /> for more information.</para>
    /// </summary>
    public enum EpubMetadataLinkProperty
    {
        /// <summary>
        /// <para>The 'onix' property. Indicates that the referenced resource is an ONIX record.</para>
        /// <para>See <see href="https://www.w3.org/TR/epub/#sec-onix" /> for more information.</para>
        /// </summary>
        ONIX = 1,
